// Playing around with filter/search/query sandboxes.
...
/* 
    The abstracted search bar problem.

    If a user types "germany" into a search box, but your data says "Germany", a simple .includes() or === check will fail. To fix this, we "normalize" the data.

    Challenge: Build a mini search engine (sans frontend ofc) for the championsLeagePlayers array. With a variable called userInput which is set to fRaNcE, use .filter to find all players from that country.
*/
